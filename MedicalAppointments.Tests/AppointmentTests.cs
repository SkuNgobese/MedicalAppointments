...
namespace MedicalAppointments.Tests
{
    ...
    public class AppointmentTests
    {
        ...
        public void Setup()
        {
            ...
            _mockDoctor = new Mock<Doctor>();
            _mockDoctor.Setup(d => d.Id).Returns(1);
            _mockDoctor.Setup(d => d.Specialization).Returns("Cardiology");

            _mockPatient = new Mock<Patient>();
            _mockPatient.Setup(p => p.Id).Returns(2);

            // Initialize Appointment with mock objects
            _appointment = new Appointment
            {
                Id = 1,
                Date = DateTime.Now.AddDays(1),
                Doctor = _mockDoctor.Object,
                Patient = _mockPatient.Object
            };
